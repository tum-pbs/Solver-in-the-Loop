...
for i in range(1, params['simsteps']):
    ...
    if params['thumb']:
        ...
        save_img(st[-1].density.data,          10000., thumb_path + "/dens_{:06d}.png".format(i))
        save_img(st[-1].velocity.data[1].data, 10000., thumb_path + "/velU_{:06d}.png".format(i))
        save_img(st[-1].velocity.data[0].data, 10000., thumb_path + "/velV_{:06d}.png".format(i))
