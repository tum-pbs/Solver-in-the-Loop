...
import os, sys, glob, logging, argparse, pickle, distutils.dir_util
...
for i in range(1, params['simsteps']):
    ...
    if params['thumb'] and params['output'] is not None:
        ...
        save_img(st[-1].velocity.data[1].data, 100000., thumb_path + "/velU_{:06d}.png".format(i))
        save_img(st[-1].velocity.data[0].data, 100000., thumb_path + "/velV_{:06d}.png".format(i))
